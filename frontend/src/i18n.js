...
export const T = {
  ...
  calib_g2: {"ua":"У вас має бути налаштована кнопка «Таблиці результатів» (будь-яка на ваш вибір).","ru":"У вас должна быть назначена кнопка «Таблицы результатов» (любая на ваш выбор).","en":"You must have a key bound to open the “Scoreboard” (any key you like)."},
