...
export const T = {
  ...
  reminders_label: {"ua":"Нагадування про лотуси та руни мудрості","ru":"Напоминания о лотосах и рунах мудрости","en":"Lotus & Wisdom rune reminders"},
  reminders_desc: {"ua":"Звуковий сигнал та іконка за 15 секунд до появи лотуса або руни мудрості.","ru":"Звуковой сигнал и иконка за 15 секунд до появления лотоса или руны мудрости.","en":"A sound and an icon 15 seconds before a lotus or a wisdom rune spawns."},
  reminders_volume: {"ua":"Гучність звуку","ru":"Громкость звука","en":"Sound volume"},
  reminders_info: {"ua":"Нагадування про лотоси спрацьовує на 3, 6, 9 та 12 хвилині гри. Нагадування про руну мудрості — кожні 7 хвилин (7, 14, 21…) протягом усієї гри. Сигнал лунає за 15 секунд до появи.","ru":"Напоминание о лотосах срабатывает на 3, 6, 9 и 12 минуте игры. Напоминание о руне мудрости — каждые 7 минут (7, 14, 21…) на протяжении всей игры. Сигнал звучит за 15 секунд до появления.","en":"Lotus reminders fire at minutes 3, 6, 9 and 12. The wisdom-rune reminder repeats every 7 minutes (7, 14, 21…) for the whole game. The cue sounds 15 seconds before the spawn."},
  rem_lotus: {"ua":"Лотос","ru":"Лотос","en":"Lotus"},
  rem_wisdom: {"ua":"Руна мудрості","ru":"Руна мудрости","en":"Wisdom rune"},
  calib_preview_title: {"ua":"ЗБЕРЕЖЕНІ ТОЧКИ КАЛІБРУВАННЯ","ru":"СОХРАНЁННЫЕ ТОЧКИ КАЛИБРОВКИ","en":"SAVED CALIBRATION POINTS"},
  calib_success_title: {"ua":"Калібрування успішне","ru":"Калибровка успешна","en":"Calibration successful"},
  update_label:       {"ua":"Оновлення","ru":"Обновления","en":"Updates"},
  update_current:     {"ua":"Версія {v} — актуальна","ru":"Версия {v} — актуальна","en":"Version {v} — up to date"},
  update_uptodate:    {"ua":"Версія актуальна","ru":"Версия актуальна","en":"Up to date"},
  update_unavail:     {"ua":"Недоступно в цій версії","ru":"Недоступно в этой версии","en":"Not available in this build"},
  update_checking:    {"ua":"Перевіряємо наявність оновлень…","ru":"Проверяем наличие обновлений…","en":"Checking for updates…"},
  update_downloading: {"ua":"Завантаження оновлення…","ru":"Загрузка обновления…","en":"Downloading update…"},
  update_available:   {"ua":"Знайдено нову версію, завантажуємо…","ru":"Найдена новая версия, загружаем…","en":"New version found, downloading…"},
  update_ready_desc:  {"ua":"Оновлення готове. Буде встановлено після закриття Dota 2.","ru":"Обновление готово. Будет установлено после закрытия Dota 2.","en":"Update ready. Will install after Dota 2 closes."},
  update_error:       {"ua":"Помилка перевірки оновлень.","ru":"Ошибка проверки обновлений.","en":"Failed to check for updates."},
  update_install_btn: {"ua":"Встановити зараз","ru":"Установить сейчас","en":"Install now"},
  update_check_btn:   {"ua":"Перевірити","ru":"Проверить","en":"Check now"},
  ...
  aghs: {"ua":"Аган","ru":"Аган","en":"Aghs"},
  tip_aghs: {"ua":"Aghanim's Scepter: змінює перезарядку ульти","ru":"Aghanim's Scepter: меняет перезарядку ульты","en":"Aghanim's Scepter: changes the ult cooldown"},
  tip_opt_aghs: {"ua":"Враховувати Aghanim's Scepter (змінює КД ульти)","ru":"Учитывать Aghanim's Scepter (меняет КД ульты)","en":"Account for Aghanim's Scepter (changes ult CD)"},
  ...
  calib_intro: {"ua":"Зайдіть у гру з ботами (5 на 5). Натисніть кнопку нижче — поверніться в гру та відкрийте таблицю результатів і тримайте її відкритою до 5 секунд. Далі поверніться в це меню, на зробленому знімку з екрану по інструкції вкажіть 5 точок.","ru":"Зайдите в игру с ботами (5 на 5). Нажмите кнопку ниже, вернитесь в игру и откройте таблицу результатов. Далее вернитесь в это меню и на сделанном снимке укажите 5 точек согласно инструкции.","en":"Start a bot match (5v5). Press the button below, then go back to the game and open the scoreboard. After that return to this menu and mark 5 spots on the screenshot according to instructions."},
  ...
  g_read_b: {"ua":"Просто відкрийте таблицю результатів в грі і потримайте 1–2 секунди — вороги та їхні рівні підставляться самі.","ru":"Просто откройте таблицу результатов в игре и подержите 1–2 секунды — враги и их уровни подставятся сами.","en":"Just open the scoreboard in game and hold it for 1–2 seconds — enemies and their levels fill in automatically."},
  ...
  calib_g_display: {"ua":"Режим показу екрану в грі має бути налаштований на «У вікні без рамки».","ru":"Режим отображения экрана в игре должен быть «В окне без рамки».","en":"In-game display mode must be set to “Borderless Window”."},
